...
public class HomePageTests extends BaseTests {
	...
	public void testLoginComSucesso_UsuarioLogado() {
		...
		loginPage.preencherEmail("sheila@teste.com");
		loginPage.preencherPassword("sheila");

		loginPage.clicarBotaoSignIn();

		assertThat(homePage.estaLogado("Sheila Gomes"), is(true));
	...
	public void testIncluirProdutoNoCarrinho_ProdutoIncluidoComSucesso() {
		...
		if (!homePage.estaLogado("Sheila Gomes")) {
	...
	String esperado_nomeCliente = "Sheila Gomes";
	...
	public void testFinalizarPedido_pedidoFinalizadoComSucesso() {
		...
		assertThat(pedidoPage.obter_email(), is("sheila@teste.com"));
